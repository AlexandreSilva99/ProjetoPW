          ...
          <?php
            if(isset($_GET['acao'])){
              ...
              if($acao == "activate"){
                ...
                $query="UPDATE produto set estado='ativo' where idProduto=".$product_id;
                mysqli_query($conn, $query);
                header("refresh:0.1;url=index.php");
                echo"<script>alert('O produto voltou a loja com sucesso.')</script>";
                exit();
              }
                              ...
                              if($_SESSION['email'] == 'Admin'){
                                echo "
                                      <td class='details-prod-buttons'>
                                        ...
                                        <br><br>
                                        <a href='detailsinactive.php?pro_id=$prodid&acao=activate'><button>Ativar</button></a>
                                        </td>
                                    </tr>
                                  </table>
                                ";
